...
class MyCustomFormState extends State<MyCustomForm> {
  ...
  TextEditingController jenis_senjataController = TextEditingController();
  ...
  Future<http.Response> adddata(index) async {
    if (index == null) {
      final http.Response response = await http
        ...
        'jenis_senjata': jenis_senjataController.text,
      ...
      child: ListView(
        children: <Widget>[
          ...
          Padding(
            ...
            child: TextFormField(
              controller: jenis_senjataController,
              ...
              validator: (value) {
                if (value.isEmpty) {
                  return 'Mohon isi jenis senjata yang dipilih';
                }
                return null;
              },
            ),
